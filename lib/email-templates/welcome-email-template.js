            ...
            <tr>
              <td style="background:#033d75;padding:20px;">
                <div style="color:#ffffff;">
                  <div style="font-size:18px;font-weight:700;letter-spacing:-0.02em;">Wealth Access</div>
            ...
            <tr>
              <td style="padding:22px 20px;">
                ...
                <p style="margin:0 0 20px;font-size:14px;color:#667085;line-height:1.65;">
                  Your Wealth Access account has been successfully verified and is now active.
                ...
                <p style="margin:0 0 10px;font-size:13px;font-weight:700;color:#1a1a2e;">
                  What you can do with Wealth Access:
                </p>
                  ...
                  <tr>
                    <td style="padding:12px 14px;background:#fffbeb;border-radius:8px;border:1px solid #fde68a;">
                      <p style="margin:0;font-size:12px;color:#92400e;line-height:1.6;">
                        <strong>🔒 Security Notice:</strong> Wealth Access will <strong>never</strong>
            ...
            <tr>
              <td style="padding:16px 20px;border-top:1px solid rgba(0,0,0,0.08);">
                <div style="font-size:12px;color:#667085;line-height:1.5;">
                  <p style="margin:0 0 6px;">This message was sent to <strong>${user.email}</strong> because you created an Wealth Access account.</p>
                  <p style="margin:0;">© ${year} Wealth Access. All rights reserved.</p>
